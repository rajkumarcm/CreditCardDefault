...
The specificity is really worse with KNN than was with Logit model for some reason and I wish not to proceed further with this model. Specificity is one of the important metrics particularly for this domain as specificity refers to the recall rate of the negative class and the negative class is those who default. Predicting poorly on those who default would cause risk to the financial health of the bank.  
