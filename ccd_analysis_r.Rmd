...
The above results are for the test set and it is better compared to KNN. Confusion matrix for the cutoff value that shows intersecting Sensitivity and Specificity would be:  
